...
class PlayerViewController: UIViewController {
    ...
    func configure(){
        ...
        //set tup user interface elements
        
        //album cover
        albumImageView.frame=CGRect(x:10,y:10,
        ...
        songNameLabel.frame=CGRect(x:10,y:albumImageView.frame.size.height+10,
                                    width: holder.frame.size.width-20,
                                    height: 70
        )
        albumNameLabel.frame=CGRect(x:10,y:albumImageView.frame.size.height+10+70,
                                    width: holder.frame.size.width-20,
                                    height: 70
        )
        artistNameLabel.frame=CGRect(x:10,y:albumImageView.frame.size.height+10+70+70,
                                    width: holder.frame.size.width-20,
                                    height: 70
        )
